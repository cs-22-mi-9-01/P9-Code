...
def main():
    ...
    parser.add_argument('-embedding', type=str, default='TFLEX', choices=['all', 'DE_TransE', 'DE_SimplE', 'DE_DistMult', 'TERO', 'TFLEX'])
    ...
    if params.embedding == "all":
        embeddings = ["DE_TransE", "DE_SimplE", "DE_DistMult", 'TERO', 'TFLEX']
    else:
